<template class="container-fluid">
  <div class="row">
    <div class="create-keep col-12 mx-auto bg-primary justify-content-around">
      <button
        class="btn btn-sm border border-white btn-block text-white bg-success btn-rounded shadow"
          ...
          <div class="modal-content border border-secondary rounded shadow">
            ...
            <div class="modal-body">
              <form>
                ...
                <div class="form-group form-check justify-content-between">
                  <input
                    type="checkbox"
